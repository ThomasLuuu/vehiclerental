...
function Header() {
  return (
    <header className='flex justify-between items-center sticky top-0 z-100 w-100 bg-white h-20 shadow-md p-5 md:px-10'>
      <div> 
        <img src={Image} className=' h-20 object-contain ml-20'  />
      </div>
      <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm' >
         <input type="text" placeholder='Loz ma' className='flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400'/>
