const CarDetailDescription = ({ car }) => {
  return (
    <div className="car__des">
      <div className="car__des-container">
        <div className="car__des-left">
          <h3>Private vehicle for rent. Owner {car.ownerName}</h3>
          <p className="car__des-content">{car.description}</p>
        </div>
        <div className="car__des-right">
          <img crossorigin="anonymous" src={car.ownerImage} alt="owner-avatar" />
        </div>
      </div>
      <div className="car__des-divider"></div>
      <div className="car__des-note">
        <svg
          viewBox="0 0 32 32"
        ...
        <div>
          <p>Enhanced hygiene</p>
          <p>This host has committed to CarRental's 5-step enhanced cleaning process.</p>
        </div>
      </div>
      <div className="car__des-note">
        <svg
        ...
        <div>
          <p>Self check-in</p>
          <p>You can meet the owner to get the vehicle.</p>
        </div>
      </div>
      <div className="car__des-note">
        <svg
        ...
        <div>
          ...
          <p>92% of guests recently gave a 5-star rating to the check-in process.</p>
        </div>
      </div>
      <div className="car__des-divider"></div>
    </div>
